...
public class EmoticonsTextViewnew extends TextView {
	public EmoticonsTextViewnew(Context context) {
		super(context);
	}

	public EmoticonsTextViewnew(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
	}

	public EmoticonsTextViewnew(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
